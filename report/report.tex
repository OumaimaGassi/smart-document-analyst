...
\includegraphics[width=4cm]{uir_logo.png}\\[1cm]

{\large \textbf{Université Internationale de Rabat}}\\[0.2cm]
{\normalsize AI \& Big Data Program --- S8 Integrated Project}\\[0.2cm]
{\normalsize Academic Year 2025--2026}\\[1.5cm]

\rule{\textwidth}{0.5pt}\\[0.5cm]
{\Huge \textbf{Smart Document Analyst}}\\[0.4cm]
{\Large A Multi-Agent AI System for Document\\Classification, Extraction, Summarization,\\and Report Generation}\\[0.5cm]
